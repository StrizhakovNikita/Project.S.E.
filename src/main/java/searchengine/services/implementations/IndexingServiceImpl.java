...
public class IndexingServiceImpl implements IndexingService {
    ...
    private String getErrorMessage(Exception e) {
        ...
        if (e instanceof CancellationException || e instanceof InterruptedException || e instanceof RejectedExecutionException){
            return properties.getInterruptedByUserMessage();
        } else if (e instanceof SSLHandshakeException
                || e instanceof CertPathValidatorException || e instanceof InvalidDataAccessApiUsageException){
